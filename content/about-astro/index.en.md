...
## Why Choose Astro for This Workshop?

### Simplified Setup
- No local Airflow installation required
- Cloud-based environment ready in minutes
- Pre-configured with workshop requirements

### Latest Features
- Access to Airflow 3.0 features immediately
- Enhanced UI and new capabilities
- Production-ready environment for testing

### Learning Focus
- Concentrate on Airflow concepts, not infrastructure
- Real-world platform experience
- Seamless transition from learning to production use
...
::alert[Ready to experience the power of managed Airflow? Let's continue to understand the workshop use case and architecture.]{type="success"}