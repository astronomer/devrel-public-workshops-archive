...
If you're running this workshop in your own AWS account, follow these instructions to set up the required services for Module 4.
...
### AWS Credentials
Set up your credentials for Exercise 4:
...
::alert[Your AWS account is now ready for the workshop!]{type="success"}
