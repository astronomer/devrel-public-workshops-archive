...
1. Create a [free trial of Astro](https://www.astronomer.io/lp/signup/?utm_source=conference&utm_medium=web&utm_campaign=devrel-workshop).
    ...
    <img src="doc/screenshot-trial-setup.png" style="max-width: 70%;">
...
3. Under _Select a Git provider for manual configuration_, select _GitHub_ and enter the following details:
    ...
    <img src="doc/screenshot-select-git-repo.png" style="max-width: 70%;">

**You now have the Astro IDE with the project ready to go.**

<img src="doc/screenshot-astro-ide.png" style="max-width: 70%;">
...
2. In the dialog, search for and select _Generic_, then enter the following details:
    ...
    <img src="doc/screenshot-add-connection-generic.png" style="max-width: 70%;">
    ...
    <img src="doc/screenshot-add-connection.png" style="max-width: 70%;">
...
2. While the deployment is starting, click the dropdown next to _Sync to Test_ and select _Test Deployment Details_.
    ...
    <img src="doc/screenshot-open-deployment-details.png" style="max-width: 70%;">
...
5. Click _Update Environment Variables_.
    ...
    <img src="doc/screenshot-env-vars.png" style="max-width: 70%;">
...
6. Back in the Astro IDE, once the test deployment is ready, select _Open Airflow_, from the same dropdown menu.
    ...
    <img src="doc/screenshot-open-airflow.png" style="max-width: 70%;">

7. In the Airflow UI, open the Dags view from the left menu and trigger the `setup` Dag using the play button.

    <img src="doc/screenshot-trigger-setup-dag.png" style="max-width: 70%;">
...
<img src="doc/screenshot-support-portal-base.png" style="max-width: 70%;">
...
<img src="doc/screenshot-analyzed-review.png" style="max-width: 70%;">
...
<img src="doc/screenshot-routed-review.png" style="max-width: 70%;">
...
<img src="doc/screenshot-embedded-reviews.png" style="max-width: 70%;">
...
<img src="doc/screenshot-required-actions.png" style="max-width: 70%;">

<img src="doc/screenshot-hitl-form.png" style="max-width: 70%;">
...
<img src="doc/screenshot-final-state.png" style="max-width: 70%;">
